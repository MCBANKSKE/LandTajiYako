        ...
        <div class="row align-items-center gy-5">
          ...
          <div class="col-lg-6 order-lg-1" data-aos="fade-right" data-aos-delay="300">
            <div class="content-wrapper">
              ...
              <h2>About Taji Yako Properties Limited</h2>

              <p>Taji Yako Properties Limited is a premier real estate company dedicated to helping individuals and businesses find their perfect property solutions in Kenya. With years of experience in the industry, we have established ourselves as a trusted name in real estate, known for our integrity, professionalism, and commitment to excellence.</p>

              <div class="stats-grid">
                <div class="stat-item" data-aos="zoom-in" data-aos-delay="400">
                  <div class="stat-number">
                    <span data-purecounter-start="0" data-purecounter-end="2847" data-purecounter-duration="2" class="purecounter"></span>+
                  </div>
              ...
              <div class="cta-wrapper">
                ...
                <div class="contact-quick">
                  ...
                  <div class="contact-text">
                    ...
                    <a href="tel:+254720927989">+254 720 927 989</a>
                  </div>
                </div>
              </div>
            </div>
